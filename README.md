...
Like clang++, g++ also generated the similar code for all 4 loops, so they had similar timing but sadly, loops are not vectorized. To compile the code with g++, use the command below.
